...
public class ExpressionAPIClient {
     ...
     */
    public ExpressionAPIClient(URL url) {
     ...
     * validity.
     */
    public ExpressionAPIClient(URL url, AuthToken token) throws UnauthorizedException, IOException {
     ...
     * credentials.
     */
    public ExpressionAPIClient(URL url, String user, String password) throws UnauthorizedException, IOException {
     ...
     * credentials.
     */
    public ExpressionAPIClient(URL url, String user, String password, URL auth) throws UnauthorizedException, IOException {
    ...
    /**
     * <p>Original spec-file function name: get_differentialExpressionMatrixSet</p>
     * <pre>
     * </pre>
     * @param   params   instance of type {@link us.kbase.expressionapi.GetDiffExprMatrixParams GetDiffExprMatrixParams} (original type "getDiffExprMatrixParams")
     * @return   instance of type {@link us.kbase.expressionapi.GetDiffExprMatrixOutput GetDiffExprMatrixOutput} (original type "getDiffExprMatrixOutput")
     * @throws IOException if an IO exception occurs
     * @throws JsonClientException if a JSON RPC exception occurs
     */
    public GetDiffExprMatrixOutput getDifferentialExpressionMatrixSet(GetDiffExprMatrixParams params, RpcContext... jsonRpcContext) throws IOException, JsonClientException {
    ...
    public Map<String, Object> status(RpcContext... jsonRpcContext) throws IOException, JsonClientException {
        ...
        List<Map<String, Object>> res = caller.jsonrpcCall("ExpressionAPI.status", args, retType, true, false, jsonRpcContext, this.serviceVersion);
        return res.get(0);
    }
}
