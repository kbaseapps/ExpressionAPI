...
def get_config():
    ...
    for nameval in config.items(get_service_name() or 'ExpressionAPI'):
        retconfig[nameval[0]] = nameval[1]
    return retconfig

config = get_config()

from ExpressionAPI.ExpressionAPIImpl import ExpressionAPI  # noqa @IgnorePep8
impl_ExpressionAPI = ExpressionAPI(config)
...
class Application(object):
    ...
    def __init__(self):
        ...
        self.rpc_service.add(impl_ExpressionAPI.get_differentialExpressionMatrixSet,
