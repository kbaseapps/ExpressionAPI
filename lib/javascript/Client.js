...
function ExpressionAPI(url, auth, auth_cb, timeout, async_job_check_time_ms, service_version) {
    var self = this;
    ...
    var _auth_cb = auth_cb;
     ...
     this.get_differentialExpressionMatrixSet = function (params, _callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "ExpressionAPI.get_differentialExpressionMatrixSet",
     ...
     this.get_enhancedFilteredExpressionMatrix = function (params, _callback, _errorCallback) {
        ...
        if (typeof arguments === 'function' && arguments.length > 1+2)
            throw 'Too many arguments ('+arguments.length+' instead of '+(1+2)+')';
        return json_call_ajax(_url, "ExpressionAPI.get_enhancedFilteredExpressionMatrix",
            [params], 1, _callback, _errorCallback);
    };
    ...
    this.status = function (_callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "ExpressionAPI.status",
